...
const Data = () => {
  ...
  const originalText = "Saurav Kumar Singh";
  ...
  return (
    <div className="home__data">
      ...
      repeat={Infinity}
    />
      <p className="home__description">Passionate about developing modern web and mobile applications for various purposes.</p>
